...
// let allInputGroup = document.getElementsByClassName("inputGroup");
// console.log(allInputGroup);

// let inputGroup = document.getElementsByClassName("inputGroup")[0];
...
// let updateHelperText = (input, message, isValid)=>{
//     // let helperText = input.getElementsByClassName()[0];
// }
